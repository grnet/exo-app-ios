...
enum PublicKeyEnv {
	...
	var stringRepresentation: StaticString {
		switch self {
		case .production: return "errtUx7t4g9VQ5huiRCLP14N+QadrIYS9/P0Fcd2NwAJDHkWSuhrhvZQV01F0sGshJ+qnvjf9n8Pxe6/wgaD9A=="
		case .development: return "errtUx7t4g9VQ5huiRCLP14N+QadrIYS9/P0Fcd2NwAJDHkWSuhrhvZQV01F0sGshJ+qnvjf9n8Pxe6/wgaD9A=="
		}
	}
}
